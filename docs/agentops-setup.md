...
Follow the instructions in [agentops/resources/README.md](../agentops/resources/README.md) to deploy agent resources and production jobs.
...
[Agent resource config guide](../agentops/resources/README.md)  to propose, test, and deploy
