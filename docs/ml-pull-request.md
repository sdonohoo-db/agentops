...
Opening a pull request will trigger a[workflow](../.github/workflows/agentops-run-tests.yml) 
...
* [Staging workspace registered model](https://adb-3527003717004027.7.azuredatabricks.net/ml/models/staging-agentops-model)
* [Prod workspace registered model](https://adb-346253566264244.4.azuredatabricks.net/ml/models/prod-agentops-model). 
