...
git add README.md docs .gitignore agentops/resources/README.md
...
* You must be a Databricks workspace admin in the staging and prod workspaces. 
  ...
  [staging workspace admin console](https://adb-3527003717004027.7.azuredatabricks.net#setting/accounts) and
  [prod workspace admin console](https://adb-346253566264244.4.azuredatabricks.net#setting/accounts). 
...
If you want to use different catalog names, please update the target names declared in the[agentops/databricks.yml](../agentops/databricks.yml) file.
...
Follow the instructions in [agentops/resources/README.md](../agentops/resources/README.md) to deploy ML resources
and production jobs.
...
[ML resource config guide](../agentops/resources/README.md)  to propose, test, and deploy
